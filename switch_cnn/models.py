...
class AlexNetMod(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope("AlexNetMod"):
            x_norm = tf.layers.batch_normalization(images, training=self.is_training)
            ...
            conv_0 = maxpool_layer(conv_0,
                                   ...
                                   strides=[1, 3, 3, 1],
                                   name='maxpool_0')
            conv_0 = tf.layers.batch_normalization(conv_0, training=self.is_training)
            ...
            conv_1 = maxpool_layer(conv_1,
                                   ...
                                   strides=[1, 2, 2, 1],
                                   name='maxpool_1')
            conv_1 = tf.layers.batch_normalization(conv_1, training=self.is_training)
            ...
            conv_2 = tf.layers.batch_normalization(conv_2, training=self.is_training)
            # =================================================================
            conv_3 = conv_layer(conv_2,
                                channels_in=384,
                                channels_out=384,
            ...
            conv_3 = tf.layers.batch_normalization(conv_3, training=self.is_training)
            # =================================================================
            conv_4 = conv_layer(conv_3,
                                channels_in=384,
                                channels_out=256,
            ...
            conv_4 = maxpool_layer(conv_4,
                                   ...
                                   strides=[1, 2, 2, 1],
                                   name='maxpool_4')
            conv_4 = tf.layers.batch_normalization(conv_4, training=self.is_training)
            ...
            fc_5      = tf.nn.relu(fc_5)
            fc_5      = tf.nn.dropout(fc_5, self.keep_prob)
            fc_5 = tf.layers.batch_normalization(fc_5, training=self.is_training)
            # =================================================================
            fc_6    = fc_layer(fc_5, 512, 64, name='fc_6')
            fc_6    = tf.nn.relu(fc_6)
            fc_6    = tf.nn.dropout(fc_6, self.keep_prob)
            fc_6 = tf.layers.batch_normalization(fc_6, training=self.is_training)
            # =================================================================
